...
conn = pg2.connect(database='postgres', user='brad',password='')
...
conn = pg2.connect(dbname = 'postgres', user='brad',password='...')
...
folder_path = '/Users/brad/Dropbox/cathy/sql-python/data/lecture-example/'
